...
@section('visitor_menu_class','open active')
        ...
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
            <div class="widget-box" style="padding-top: 4px;">
                <div class="widget-header">
                    <a href="{{ route('backend.visitor.index') }}" class="btn btn-default btn-sm">List</a>
                            ...
                            <div class="col-md-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Organization</th>
                                        <td> : </td>
                                        <td>{{ $visitor->represented_organization }}</td>
                                    </tr>
