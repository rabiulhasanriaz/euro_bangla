    ...
    <div id="content-container">
        <div id="login-container">
            <div id="login-sub-container">
                ...
                <div id="login-sub">
                    <div id="forms">
                        <form id="login_form" action="{{ route('user.forgot-password') }}" method="post">
                            @csrf
                            <div class="input-req-login">
                                <label for="user">Phone</label>
                            </div>
                            <div class="input-field-login icon username-container">
                                <input name="mobile_phone" id="user" autofocus="autofocus"
                                       placeholder="Enter your phone." class="std_textbox" tabindex="1"
                                       required="" type="text">
                            </div>
                            ...
                            <div class="controls">
                                <div class="login-btn">
                                    <button type="submit" id="login_submit" tabindex="3">Send Password</button>
                                </div>

                                <div class="forgot-password" style="float: right;margin-top: 30px;">
                                    <a href="{{ route('user.login') }}" style="color: #455cff;">Login</a>
                                </div>
                            </div>
                        </form>
