...
<div id="plugins-panel" class="panel-left visible">
	...
	<p><?php printf( __( 'Here is a list of recommended plugins you should install to get most out of the Construction Landing Page. Though every plugin is optional, we recommend you to at least install %1$sRaraTheme Companion%2$s, %1$sBlossomThemes Email Newsletter%2$s, %1$sContact Form 7%2$s & %1$sRara One Click Demo Import%2$s to create a website similar to the Construction Landing Page demo and also to ensure every feature of the theme works correctly.', 'the-conference' ), '<strong>', '</strong>' ) ?></p>
