...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.rarathemes.com/the-conference/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'the-conference' ); ?>" target="_blank">
