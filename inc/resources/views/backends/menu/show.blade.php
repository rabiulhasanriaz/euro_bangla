        ...
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
            <div class="widget-box" style="padding-top: 4px;">
                <div class="widget-header">
                    <a href="{{ route('backend.menu.index') }}" class="btn btn-default btn-sm">List</a>
                    <a href="{{ route('backend.menu.edit', $menu->id) }}" class="btn btn-default btn-sm">Edit</a>
                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="created_by" class="col-xs-12 col-sm-8"
                                                       value="{{ $menu->createdInfo->name }}" disabled/>
                                            </span>
                                            </div>
                                        </div>
                                    @endif

                                    @if(!empty($menu->updated_at))
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="updated_by" class="col-xs-12 col-sm-8"
                                                       value="{{ $menu->updatedInfo->name }}" disabled/>
                                            </span>
                                            </div>
                                        </div>
                                    @endif
