            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form class="form-horizontal" action="{{ route('backend.sub-menu.update', $sub_menu->id) }}" method="post">
                            @csrf
                                    ...
                                    <span class="block input-icon input-icon-right">
                                        <select name="menu" id="menu" class="col-xs-12 col-sm-8" placeholder="Select Menu" required>
                                            ...
                                            @foreach ($menus as $row)
                                                <option value="{{ $row->id }}" {{ ($sub_menu->menu_id == $row->id)? 'selected':'' }}>{{ $row->title }}</option>
                                            @endforeach
                                        </select>
                                    </span>
                                </div>
                            ...
                            <div class="form-group @if($errors->has('content')) has-error @endif">
                                ...
                                <div class="col-xs-12 col-sm-7">
                                    <span class="block input-icon input-icon-right">
                                        <textarea name="content" id="content" class="col-xs-12 col-sm-8" placeholder="Enter Menu Content">{{ $sub_menu->content }}</textarea>
                                    </span>
                                </div>
